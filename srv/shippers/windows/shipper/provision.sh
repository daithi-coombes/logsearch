...
if [ ! -e $DEST/logstash.jar ] ; then
    echo "Downloading logstash-1.1.13-pr19b2(patched)..."
    curl --location -o $DEST/logstash.jar http://ci-elasticsearch-development-flow.s3.amazonaws.com/logstash-1.1.13-monolithic-pr19b2.jar
fi
